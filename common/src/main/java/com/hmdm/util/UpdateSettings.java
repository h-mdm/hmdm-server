...
// A variant for free limited version will be copied by opensource-prod.bat
public class UpdateSettings {
    // Set to false for custom web builds
    public static boolean WEB_UPDATE_ENABLED = true;

    // Here CUSTOMER_DOMAIN template can be used, replaced with the customer's domain. In the future, this could be used
    // to limit access to updates
