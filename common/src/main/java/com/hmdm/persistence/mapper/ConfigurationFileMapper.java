...
public interface ConfigurationFileMapper {
    ...
    @Select("SELECT cf.id AS id, " + "       cf.configurationId AS configurationId,  "
            + "       f.description AS description,  " + "       f.devicePath AS devicePath,  "
    ...
    ConfigurationFile getConfigurationFileByPath(
            @Param("configurationId") int configurationId, @Param("path") String path);
    ...
    // Used only in the migration task from old to new method of storing configuration files
    @Update(
            "UPDATE configurationFiles SET configurationId=#{configurationId}, description=#{description}, devicePath=#{devicePath}, "
    ...
    @Select({
        "SELECT configurationFiles.id             AS id, "
    ...
    List<FileConfigurationLink> getConfigurationFileLinks(
            @Param("customerId") Integer customerId, @Param("userId") Integer userId, @Param("id") Integer fileId);
