...
document.localization ['fr_FR'] = {
    ...
    'success.settings.language.saved': 'Paramètres de langue enregistrés avec succès',
    ...
    'form.configuration.app.versions.action.prohibit': 'Ne pas installer',
    ...
    'form.configuration.settings.common.timeout': 'Gérer le temps de repos à l\'écran',
