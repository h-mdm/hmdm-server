...
public class ConfigureModule extends AbstractModule {
        ...
        protected void configure() {
                ...
                this.bindConstant().annotatedWith(Names.named(secureEnrollmentParameter)).to(
                                secureEnrollment != null && (secureEnrollment.equals("1")
                ...
                this.bindConstant().annotatedWith(Names.named(preventDuplicateParameter)).to(
                                preventDuplicate != null && (preventDuplicate.equals("1")
                ...
                this.bindConstant().annotatedWith(Names.named(rebrandingVendorLinkParameter))
                                .to(opt != null ? opt : "");
                ...
                this.bindConstant().annotatedWith(Names.named(rebrandingMobileNameParameter))
                                .to(opt != null ? opt : "");
                opt = this.context.getInitParameter(rebrandingSignupLinkParameter);
                this.bindConstant().annotatedWith(Names.named(rebrandingSignupLinkParameter))
                                .to(opt != null ? opt : "");
