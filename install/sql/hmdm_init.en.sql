...
INSERT INTO applications (id, pkg, name, showicon, customerid, system, latestversion) VALUES 
    (1, 'com.android.systemui', 'System UI', false, 1, true, 10000),
    (2, 'com.android.bluetooth', 'Bluetooth Service', false, 1, true, 10001),
    (3, 'com.google.android.gms', 'Google Services', false, 1, true, 10002),
    (34, 'com.android.email', 'Email client', true, 1, true, 10033),
    (7, 'org.kman.WifiManager', 'WiFi Manager', true, 1, false, 10006),
    (9, 'com.android.chrome', 'Chrome Browser', true, 1, true, 10008),
    (10, 'com.sec.android.app.browser', 'Browser (Samsung)', true, 1, true, 10009),
    ...
    (13, 'com.android.gallery3d', 'Gallery', true, 1, true, 10012),
    (14, 'com.sec.android.gallery3d', 'Gallery (Samsung)', true, 1, true, 10013),
    (15, 'com.android.vending', 'Google Payment support', false, 1, true, 10014),
    ...
    (21, 'com.android.camera', 'Camera (generic)', true, 1, true, 10020),
    (22, 'com.huawei.camera', 'Camera (Huawei)', true, 1, true, 10021),
    (23, 'org.codeaurora.snapcam', 'Camera (Lenovo)', true, 1, true, 10022),
    (24, 'com.mediatek.camera', 'Camera (Mediatek)', true, 1, true, 10023),
    (25, 'com.sec.android.app.camera', 'Camera (Samsung, legacy)', true, 1, true, 10024),
    (26, 'com.sec.android.camera', 'Camera (Samsung)', true, 1, true, 10025),
    (27, 'com.google.android.apps.maps', 'Google Maps', true, 1, true, 10026),
    (28, 'com.touchtype.swiftkey', 'Swiftkey keyboard extension', false, 1, true, 10027),
    (29, 'com.android.contacts', 'Contacts', true, 1, true, 10028),
    (31, 'com.sec.android.app.myfiles', 'File Manager (Samsung)', true, 1, true, 10030),
    (32, 'com.android.settings', 'Settings (usually must be disabled!)', false, 1, true, 10031),
    (33, 'com.sec.android.inputmethod', 'Keyboard settings (Samsung)', false, 1, true, 10032),
    (36, 'com.samsung.android.email.provider', 'Email service (Samsung)', false, 1, true, 10035),
    (37, 'android', 'Android system package', false, 1, true, 10036),
    (38, 'com.android.mms', 'Messaging (generic)', true, 1, true, 10037),
    (39, 'com.google.android.apps.messaging', 'Messaging (Google)', true, 1, true, 10038),
    (40, 'com.android.dialer', 'Phone (generic UI)', true, 1, true, 10039),
    (41, 'com.sec.phone', 'Phone (Samsung)', true, 1, true, 10040),
    (42, 'com.android.phone', 'Phone (generic service)', true, 1, true, 10041),
    (43, 'com.huaqin.filemanager', 'File manager (Lenovo)', true, 1, true, 10042),
    (6, 'com.google.android.apps.photos', 'Gallery (Google)', true, 1, true, 10005),
...
INSERT INTO configurations (id, name, description, type, password, backgroundcolor, textcolor, backgroundimageurl, iconsize, desktopheader, usedefaultdesignsettings, customerid, gps, bluetooth, wifi, mobiledata, mainappid, eventreceivingcomponent, kioskmode, qrcodekey, contentappid,autoupdate, blockstatusbar, systemupdatetype, systemupdatefrom, systemupdateto) VALUES (1, 'Common - Minimal', 'Suitable for generic Android devices; minimum of apps installed', 0, '12345678', '', '', NULL, 'SMALL', 'NO_HEADER', true, 1, NULL, NULL, NULL, NULL, 10045, 'com.hmdm.launcher.AdminReceiver', false, '6fb9c8dc81483173a0c0e9f8b2e46be1', NULL, false, false, 0, NULL, NULL);
